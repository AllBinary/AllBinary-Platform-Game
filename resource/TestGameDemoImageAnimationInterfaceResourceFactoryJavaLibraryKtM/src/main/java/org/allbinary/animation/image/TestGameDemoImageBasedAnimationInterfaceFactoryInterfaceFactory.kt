...
open public class TestGameDemoImageBasedAnimationInterfaceFactoryInterfaceFactory : BaseResourceAnimationInterfaceFactoryInterfaceFactory {
        
public constructor ()                        

                            : super("Image Animations", Hashtable<Any, Any>(), Hashtable<Any, Any>(), Hashtable<Any, Any>()){
...
var level = level
    ...
    var loadingString: String = stringMaker!!.append(this.toString())!!.append(" Loading: ")!!.toString()!!
