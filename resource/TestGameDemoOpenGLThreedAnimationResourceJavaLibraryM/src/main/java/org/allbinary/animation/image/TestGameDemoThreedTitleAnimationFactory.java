...
public class TestGameDemoThreedTitleAnimationFactory
{
    private static final TestGameDemoThreedTitleAnimationFactory instance = new TestGameDemoThreedTitleAnimationFactory();
    ...
    throws Exception
    {
        ...
        return new TestGameDemoThreedTitleAnimation(animationInterfaceArray, 
