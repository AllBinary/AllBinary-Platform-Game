...
open public class TestGameDemoAndroidAnimationInterfaceFactoryEarlyResourceInitialization : ResourceInitialization {
...
featuredAnimationInterfaceFactoryInterfaceFactory!!.add(TestGameDemoEarlyResourcesImageBasedAnimationInterfaceFactoryInterfaceFactory())
featuredAnimationInterfaceFactoryInterfaceFactory!!.add(TestGameDemoEarlyResourcesOpenGLESImageBasedAnimationInterfaceFactoryInterfaceFactory())
}
