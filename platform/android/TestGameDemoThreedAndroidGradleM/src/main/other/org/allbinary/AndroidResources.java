...
public class AndroidResources
{
    ...
    public class Rdrawable {
        public final int testgamedemo_icon = R.drawable.testgamedemo_icon;
    ...
    public class Rlayout {
        ...
        public final int testgamedemo_min3d_layout = R.layout.testgamedemo_min3d_layout;
        public final int testgamedemo_gl_ad_overlay_layout = R.layout.testgamedemo_gl_ad_overlay_layout;
        public final int testgamedemo_min3d_ad_overlay_layout = R.layout.testgamedemo_min3d_ad_overlay_layout;
    ...
    public class Rraw {
        public final int threed_obj = R.raw.threed_obj;
