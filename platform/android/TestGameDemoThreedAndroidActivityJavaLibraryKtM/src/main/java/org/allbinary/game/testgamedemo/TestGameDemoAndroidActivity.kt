...
this.initViewIds(intArrayOf(androidResources!!.id.testgamedemo,androidResources!!.id.testgamedemo_gl), intArrayOf(androidResources!!.layout.testgamedemo_layout,androidResources!!.layout.testgamedemo_ad_overlay_layout), intArrayOf(androidResources!!.layout.testgamedemo_gl_layout,androidResources!!.layout.testgamedemo_min3d_layout,androidResources!!.layout.testgamedemo_gl_ad_overlay_layout,androidResources!!.layout.testgamedemo_min3d_ad_overlay_layout), false)
