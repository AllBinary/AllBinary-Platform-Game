...
public class RendererActivity extends Activity //implements ISceneController
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        try
        {
            ...
            this._glSurfaceView = (OptimizedGLSurfaceView) this.findViewById(R.id.testgamedemo_gl);

            //TWB
            DisplayInfoSingleton displayInfo = DisplayInfoSingleton.getInstance();
            displayInfo.setLastSize(this._glSurfaceView.getWidth(), this._glSurfaceView.getHeight(), this.commonStateStrings.CREATE);
            //End - TWB
