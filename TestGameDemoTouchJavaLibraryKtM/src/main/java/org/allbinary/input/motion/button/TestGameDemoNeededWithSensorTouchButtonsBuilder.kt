...
open public class TestGameDemoNeededWithSensorTouchButtonsBuilder : BaseTouchInput {
...
: BasicArrayList{
    ...
    var LEFT: TouchButton = FullTouchButton(basicTouchInputFactory!!.LEFT, animationInterface, hintAnimationInterface, commonButtons!!.NORMAL_BUTTON, basicTouchButtonCellPositionFactory!!.BOTTOM_LEFT, touchButtonLocationHelper!!.getColumnsRemainderHalf(), touchButtonLocationHelper!!.getRowsRemainderHalf())
    ...
    var RIGHT: TouchButton = FullTouchButton(basicTouchInputFactory!!.RIGHT, animationInterface, hintAnimationInterface, commonButtons!!.NORMAL_BUTTON, basicTouchButtonCellPositionFactory!!.BOTTOM_RIGHT, touchButtonLocationHelper!!.getColumnsRemainderHalf(), touchButtonLocationHelper!!.getRowsRemainderHalf())
