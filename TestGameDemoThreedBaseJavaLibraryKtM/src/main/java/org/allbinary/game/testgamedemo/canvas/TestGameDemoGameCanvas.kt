...
TestGameDemoLevelBuilder(this).
    ...
    var layerManager: AllBinaryGameLayerManager = this.getLayerManager()!!
    ...
    var sceneController: AllBinarySceneController = TestGameDemoAllBinarySceneControllerFactory.getInstance()!!
